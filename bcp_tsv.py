...
def convert(bcpdata, lineterminator='\n', delimiter='\t', quote='"', newdelimiter=',', escapechar='\\', newline='\n'):
    """
    ...
    bcpdata = bcpdata.replace(newdelimiter, '')
    bcpdata = bcpdata.replace(quote, '')
...
def stream(file, lineterminator='\n', delimiter='\t', encoding='utf-8'):
    """
